...
async function main() {
  ...
  const company = await prisma.company.create({
    data: {
      name: "Nomads Eco", email: "hello@nomadseco.com", phone: "+1 (555) 123-4567",
      address: "123 Eco Street", city: "Portland", state: "OR", zip: "97201",
      country: "USA", taxId: "XX-XXXXXXX", currency: "USD",
  ...
  const client = await prisma.client.create({
    data: {
      name: "Green Planet Corp", email: "billing@greenplanet.com",
      phone: "+1 (555) 987-6543", address: "456 Sustainable Ave",
  ...
  await prisma.invoice.create({
    data: {
      number: "INV-2024-0001", status: "paid",
      issueDate: new Date("2024-01-15"), dueDate: new Date("2024-02-15"),
      paidAt: new Date("2024-02-01"),
      subtotal: 5000, taxRate: 10, taxAmount: 500, discount: 0, total: 5500, amountPaid: 5500,
